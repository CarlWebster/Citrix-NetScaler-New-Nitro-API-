...
$NSVersion = Get-vNetScalerObject -Container config -Object nsversion -Verbose;
...
$nsconfig = Get-vNetScalerObject -Container config -Object nsconfig -Verbose;
$nshostname = Get-vNetScalerObject -Container config -Object nshostname -Verbose;
...
$License = Get-vNetScalerObject -Container config -Object nslicense -Verbose;
...
$nshardware = Get-vNetScalerObject -Container config -Object nshardware -Verbose;
...
$NSIP = Get-vNetScalerObject -Container config -Object nsip -Verbose;
...
$HANodes = Get-vNetScalerObject -Container config -Object hanode -Verbose;
...
$nshttpparam = Get-vNetScalerObject -Container config -Object nshttpparam -Verbose;
...
$nstcpparam = Get-vNetScalerObject -Container config -Object nstcpparam -Verbose;
...
$nsdiameter = Get-vNetScalerObject -Container config -Object nsdiameter -Verbose; 
...
$nssystemusers = Get-vNetScalerObject -Container config -Object systemuser -Verbose;
...
$nssystemgroups = Get-vNetScalerObject -Container config -Object systemgroup -Verbose;
...
$nsmode = Get-vNetScalerObject -Container config -Object nsmode -Verbose; 
...
$snmpcommunitycounter = Get-vNetScalerObjectCount -Container config -Object snmpcommunity -Verbose; 
$snmpcommunitycount = $snmpcommunitycounter.__count
$snmpcoms = Get-vNetScalerObject -Container config -Object snmpcommunity -Verbose;    
...
$snmpmanagercounter = Get-vNetScalerObjectCount -Container config -Object snmpmanager -Verbose; 
...
if($snmpmanagercount -le 0) { WriteWordLine 0 0 "No SNMP Manager has been configured"} else {
    ...
    $snmpmanagers = Get-vNetScalerObject -Container config -Object snmpmanager -Verbose; 
...
$snmpalarms = Get-vNetScalerObject -Container config -Object snmpalarm -Verbose; 
...
$snmptrapscounter = Get-vNetScalerObjectCount -Container config -Object snmptrap -Verbose; 
$snmptrapscount = $snmptrapscounter.__count

$snmptraps = Get-vNetScalerObject -Container config -Object snmptrap -Verbose; 
...
$InterfaceCounter = Get-vNetScalerObjectCount -Container config -Object interface -Verbose; 
$InterfaceCount = $InterfaceCounter.__count
$Interfaces = Get-vNetScalerObject -Container config -Object interface -Verbose;
...
$ChannelCounter = Get-vNetScalerObjectCount -Container config -Object channel -Verbose; 
$ChannelCount = $ChannelCounter.__count
$Channels = Get-vNetScalerObject -Container config -Object interface -Verbose;
...
$IPs = Get-vNetScalerObject -Container config -Object nsip -Verbose;
...
$VLANCounter = Get-vNetScalerObjectCount -Container config -Object vlan -Verbose; 
$VLANCount = $VLANCounter.__count
$VLANS = Get-vNetScalerObject -Container config -Object vlan -Verbose;
...
$nsroute = Get-vNetScalerObject -Container config -Object route -Verbose;
...
$TDcounter = Get-vNetScalerObjectCount -Container config -Object nstrafficdomain -Verbose; 
$TDcount = $TDcounter.__count
$TDs = Get-vNetScalerObject -Container config -Object nstrafficdomain -Verbose;
...
$dnsnameservercounter = Get-vNetScalerObjectCount -Container config -Object dnsnameserver -Verbose; 
$dnsnameservecount = $dnsnameservercounter.__count
$dnsnameservers = Get-vNetScalerObject -Container config -Object dnsnameserver -Verbose;
...
$dnsaddreccounter = Get-vNetScalerObjectCount -Container config -Object dnsaddrec -Verbose; 
$dnsaddreccount = $dnsaddreccounter.__count
$dnsaddrecs = Get-vNetScalerObject -Container config -Object dnsaddrec -Verbose;
...
$nssimpleaclCounter = Get-vNetScalerObjectCount -Container config -Object nssimpleacl -Verbose; 
$nssimpleaclCount = $nssimpleaclCounter.__count
$nssimpleacls = Get-vNetScalerObject -Container config -Object nssimpleacl -Verbose;
...
$nsaclCounter = Get-vNetScalerObjectCount -Container config -Object nsacl -Verbose; 
$nsaclCount = $nsaclCounter.__count
$nsacls = Get-vNetScalerObject -Container config -Object nsacl -Verbose;
...
$authpolsldap = Get-vNetScalerObject -Container config -Object authenticationldappolicy -Verbose;
...
$authactsldap = Get-vNetScalerObject -Container config -Object authenticationldapaction -Verbose;
...
$authpolsradius = Get-vNetScalerObject -Container config -Object authenticationradiuspolicy -Verbose;
...
$authactsradius = Get-vNetScalerObject -Container config -Object authenticationradiusaction -Verbose;
...
$lbvserverscount = Get-vNetScalerObjectCount -Container config -Object lbvserver -Verbose;
$lbcount = $lbvserverscount.__count
$lbvservers = Get-vNetScalerObject -Container config -Object lbvserver -Verbose;
...
$crservercounter = Get-vNetScalerObjectCount -Container config -Object crvserver -Verbose; 
$crservercount = $crservercounter.__count
$crservers = Get-vNetScalerObject -Container config -Object crvserver -Verbose;
...
$servicescounter = Get-vNetScalerObjectCount -Container config -Object service -Verbose; 
$servicescount = $servicescounter.__count
$services = Get-vNetScalerObject -Container config -Object service -Verbose;
...
$servicegroupscounter = Get-vNetScalerObjectCount -Container config -Object servicegroup -Verbose; 
$servicegroupscount = $servicegroupscounter.__count
$servicegroups = Get-vNetScalerObject -Container config -Object servicegroup -Verbose;
...
$servercounter = Get-vNetScalerObjectCount -Container config -Object service -Verbose; 
$servercount = $servercounter.__count
$servers = Get-vNetScalerObject -Container config -Object server -Verbose;
...
$vpnglobalstascount = Get-vNetScalerObjectCount -Container config -Object vpnglobal_staserver_binding -Verbose;
...
if($vpnglobalstascounter -le 0) { WriteWordLine 0 0 "No Global Secure Ticket Authority has been configured"} else {
    ...
    $vpnglobalstas = Get-vNetScalerObject -Container config -Object vpnglobal_staserver_binding -Verbose;
...
$vpnglobalappcontrollercount = Get-vNetScalerObjectCount -Container config -Object vpnglobal_appcontroller_binding -Verbose;
...
if($vpnglobalappcontrollercounter -le 0) { WriteWordLine 0 0 "No Global App Controller has been configured"} else {
    ...
    $vpnglobalappcs = Get-vNetScalerObject -Container config -Object vpnglobal_appcontroller_binding -Verbose;
...
$vpnvserverscount = Get-vNetScalerObjectCount -Container config -Object vpnvserver -Verbose;
$vpnvservers = Get-vNetScalerObject -Container config -Object vpnvserver -Verbose;
...
#region CAG vServer basic configuration
    ...
    #region CAG Authentication LDAP Policies             
        ...
        $vpnvserverldappols = Get-vNetScalerObject -ResourceType vpnvserver_authenticationldappolicy_binding -name $vpnvserver.Name -Verbose
...
WriteWordLine 0 0 " "
    ...
    #region CAG Authentication Radius Policies             
        ...
        $errorcode = 1 
        $vpnvserverradiuspols = Get-vNetScalerObject -ResourceType vpnvserver_authenticationradiuspolicy_binding -name $vpnvserver.Name -Verbose
...
WriteWordLine 0 0 " "
    ...
    #region CAG Authentication SAML IDP Policies             
        ...
        $errorcode = 1 #Set Error code to 1
        $vpnvserversamlidppols = Get-vNetScalerObject -ResourceType vpnvserver_authenticationsamlidppolicy_binding -name $vpnvserver.Name -Verbose
...
WriteWordLine 0 0 " "
    ...
    #region CAG Session Policies        
        ...
        $errorcode = 1 #Set Error code to 1
        $vpnvserversespols = Get-vNetScalerObject -ResourceType vpnvserver_vpnsessionpolicy_binding -name $vpnvserver.Name -Verbose
...
WriteWordLine 0 0 " "
    ...
    #region CAG STA Policies        
        ...
        $errorcode = 1 #Set Error code to 1
        $vpnvserverstas = Get-vNetScalerObject -ResourceType vpnvserver_staserver_binding -name $vpnvserver.Name -Verbose
...
WriteWordLine 0 0 " "
    ...
    #region CAG Cache Policies        
        ...
        $errorcode = 1 #Set Error code to 1
        $vpnvservercachepols = Get-vNetScalerObject -ResourceType vpnvserver_cachepolicy_binding -name $vpnvserver.Name -Verbose
...
WriteWordLine 0 0 " "
    ...
    #region CAG Responder Policies        
        ...
        $errorcode = 1 #Set Error code to 1
        $vpnvserverrespols = Get-vNetScalerObject -ResourceType vpnvserver_responderpolicy_binding -name $vpnvserver.Name -Verbose
...
$vpnsessionpolicies = Get-vNetScalerObject -Container config -Object vpnsessionpolicy -Verbose;
...
$vpnsessionactions = Get-vNetScalerObject -Container config -Object vpnsessionaction -Verbose;
...
$monitorcounter = Get-vNetScalerObjectCount -Container config -Object lbmonitor -Verbose; 
$monitorcount = $monitorcounter.__count
$monitors = Get-vNetScalerObject -Container config -Object lbmonitor -Verbose;
...
$pattsetpolicies = Get-vNetScalerObject -Container config -Object policypatset -Verbose;
...
$responderpolicies = Get-vNetScalerObject -Container config -Object responderpolicy -Verbose;
...
$rewritepolicies = Get-vNetScalerObject -Container config -Object rewritepolicy -Verbose;
...
$responderactions = Get-vNetScalerObject -Container config -Object responderaction -Verbose;
...
$rewriteactions = Get-vNetScalerObject -Container config -Object rewriteaction -Verbose;
...
$tcpprofiles = Get-vNetScalerObject -Container config -Object nstcpprofile -Verbose;
...
$httprofiles = Get-vNetScalerObject -Container config -Object nshttpprofile -Verbose;
